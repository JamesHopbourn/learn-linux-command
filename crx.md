...
Zip entry offsets appear off by 566 bytes - correcting...
 copying: AUTHORS
 copying: COPYING
 copying: _locales/cs/messages.json
 copying: _locales/en/messages.json
 copying: _locales/fa/messages.json
 copying: _locales/zh/messages.json
 copying: _locales/zh_CN/messages.json
 copying: _locales/zh_TW/messages.json
 copying: background.html
 copying: css/options.css
 copying: css/popup.css
 copying: img/icons/draw_omega.js
 copying: img/icons/omega-128.png
 copying: img/icons/omega-128.svg
 copying: img/icons/omega-48.png
 copying: img/icons/omega-64.png
 copying: img/icons/omega-action-16.png
 copying: img/icons/omega-action-19.png
 copying: img/icons/omega-action-24.png
 copying: img/icons/omega-action-32.png
 copying: img/icons/omega-action.svg
 copying: js/background.js
 copying: js/background_preload.js
 copying: js/log_error.js
 copying: js/omega.js
 copying: js/omega_debug.js
 copying: js/omega_decoration.js
 copying: js/omega_pac.min.js
 copying: js/omega_target.min.js
 copying: js/omega_target_chromium_extension.min.js
 copying: js/omega_target_popup.js
 copying: js/omega_target_web.js
 copying: js/omega_webext_proxy_script.min.js
 copying: js/options.js
 copying: js/options_guide.js
 copying: js/popup.js
 copying: js/switch_profile_guide.js
 copying: lib/FileSaver/FileSaver.min.js
 copying: lib/angular-animate/angular-animate.min.js
 copying: lib/angular-bootstrap/ui-bootstrap-tpls.min.js
 copying: lib/angular-i18n/angular-locale_en-us.js
 copying: lib/angular-i18n/angular-locale_zh-cn.js
 copying: lib/angular-i18n/angular-locale_zh-hk.js
 copying: lib/angular-i18n/angular-locale_zh-tw.js
 copying: lib/angular-ladda/angular-ladda.min.js
 copying: lib/angular-loader/angular-loader.min.js
 copying: lib/angular-sanitize/angular-sanitize.min.js
 copying: lib/angular-spectrum-colorpicker/angular-spectrum-colorpicker.min.js
 copying: lib/angular-ui-router/angular-ui-router.min.js
 copying: lib/angular-ui-sortable/sortable.min.js
 copying: lib/angular-ui-utils/validate.min.js
 copying: lib/angular/angular.min.js
 copying: lib/blob/Blob.js
 copying: lib/bootstrap/css/bootstrap.min.css
 copying: lib/bootstrap/fonts/glyphicons-halflings-regular.eot
 copying: lib/bootstrap/fonts/glyphicons-halflings-regular.svg
 copying: lib/bootstrap/fonts/glyphicons-halflings-regular.ttf
 copying: lib/bootstrap/fonts/glyphicons-halflings-regular.woff
 copying: lib/bootstrap/fonts/glyphicons-halflings-regular.woff2
 copying: lib/bootstrap/js/dropdown.js
 copying: lib/jquery-ui-1.10.4.custom.min.js
 copying: lib/jquery/jquery.min.js
 copying: lib/jqueryui-touch-punch/jquery.ui.touch-punch.min.js
 copying: lib/jsondiffpatch/jsondiffpatch.min.js
 copying: lib/ladda/ladda-themeless.min.css
 copying: lib/ladda/ladda.min.js
 copying: lib/ngprogress/ngProgress.min.js
 copying: lib/script.js/script.min.js
 copying: lib/shepherd.js/shepherd-theme-arrows.css
 copying: lib/shepherd.js/shepherd.min.js
 copying: lib/spectrum/spectrum.css
 copying: lib/spectrum/spectrum.js
 copying: lib/spin.js/spin.js
 copying: lib/tether/tether.js
 copying: options.html
 copying: partials/about.html
 copying: partials/apply_options_confirm.html
 copying: partials/cannot_delete_profile.html
 copying: partials/delete_attached.html
 copying: partials/delete_profile.html
 copying: partials/fixed_auth_edit.html
 copying: partials/general.html
 copying: partials/input_group_clear.html
 copying: partials/io.html
 copying: partials/new_profile.html
 copying: partials/omega_profile_select.html
 copying: partials/options_welcome.html
 copying: partials/profile.html
 copying: partials/profile_fixed.html
 copying: partials/profile_pac.html
 copying: partials/profile_rule_list.html
 copying: partials/profile_switch.html
 copying: partials/profile_unsupported.html
 copying: partials/profile_virtual.html
 copying: partials/rename_profile.html
 copying: partials/replace_profile.html
 copying: partials/reset_options_confirm.html
 copying: partials/rule_remove_confirm.html
 copying: partials/rule_reset_confirm.html
 copying: partials/ui.html
 copying: popup.html
 copying: popup/css/dialog.css
 copying: popup/css/index.css
 copying: popup/index.html
 copying: popup/js/i18n.js
 copying: popup/js/index.js
 copying: popup/js/keyboard.js
 copying: popup/js/keyboard_help.js
 copying: popup/js/loader.js
 copying: popup/js/profiles.js
 copying: popup/js/proxy_not_controllable.js
 copying: popup/proxy_not_controllable.html
 copying: manifest.json
 copying: _metadata/
 copying: _metadata/verified_contents.json
```
