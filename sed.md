...
➜ (lldb) p/t 19260817
(int) $6 = 0b00000001001001011110010110010001
➜ pbpaste|sed 's/0b// ; s/.\{4\}/& /g'
0000 0001 0010 0101 1110 0101 1001 0001

➜ (lldb) p/t 19260817
(int) $6 = 0b00000001001001011110010110010001
➜ pbpaste|gsed 's/0b// ; /^1/ s/1/N/ ; /^0/ s/0/P/ ; s/.\{4\}/& /g'
P000 0001 0010 0101 1110 0101 1001 0001

➜ (lldb) p/t 19260817
(int) $6 = 0b00000001001001011110010110010001
➜ pbpaste|gsed 's/0b// ; /^1/ s/1/N/ ; /^0/ s/0/P/ ; s/1/2/g ; s/0/1/g ; s/2/0/g ; s/.\{4\}/& /g'
...
➜ (lldb) p/t 19890604
(int) $7 = 0b00000001001011111000000110101100
➜ pbpaste|gsed 's/0b// ; /^1/ s/1/N/ ; /^0/ s/0/P/ ; s/1/2/g ; s/0/1/g ; s/2/0/g ; s/N/1/ ; s/P/0/ ; s/.\{4\}/& /g'
0111 1110 1101 0000 0111 1110 0101 0011

➜ (lldb) p/t -1
(int) $8 = 0b11111111111111111111111111111111
➜ pbpaste|gsed 's/0b// ; /^1/ s/1/N/ ; /^0/ s/0/P/ ; s/.\{4\}/& /g'
