...
#### 匹配字符后再替换
```
➜ echo 1000|gsed '/^1/ s/1/T/'
X000

➜ echo 0000|gsed '/^1/ s/1/T/'
0000

➜ node bin.js 19260817
00000001001001011110010110010001

➜ node bin.js 19260817|gsed '/^1/ s/1/T/ ; /^0/ s/0/F/'
F0000001001001011110010110010001

➜ node bin.js 19260817|gsed '/^1/ s/1/T/ ; /^0/ s/0/F/ ; s/1/2/g ; s/0/1/g ; s/2/0/g'
F1111110110110100001101001101110

➜ node bin.js 19260817|gsed '/^1/ s/1/T/ ; /^0/ s/0/F/ ; s/1/2/g ; s/0/1/g ; s/2/0/g ; s/T/1/ ; s/F/0/'
01111110110110100001101001101110

➜ node bin.js 19890604|gsed '/^1/ s/1/T/ ; /^0/ s/0/F/ ; s/1/2/g ; s/0/1/g ; s/2/0/g ; s/T/1/ ; s/F/0/'
01111110110100000111111001010011
```
#### 替换单引号
```
